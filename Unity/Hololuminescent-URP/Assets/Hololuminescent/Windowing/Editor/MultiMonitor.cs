...
public class MultiMonitorGamePreview : EditorWindow
{
    ...
    [MenuItem("Window/Hololuminescent Display Preview Settings")]
    public static void ShowWindow()
    {
        GetWindow<MultiMonitorGamePreview>("Hololuminescent Display Preview Settings");
    }
    ...
    private void OnGUI()
    {
        GUILayout.Label("Hololuminescent Display Preview Settings", EditorStyles.boldLabel);
